...
export const COPY = {
  ...
  'meds.hint':
    '최근 처방약 불러오기는 이 브라우저에 지난 진료 메모가 있을 때만 보여요',
  'pill.go': '그럼 모양이랑 색으로 찾아볼게요.',
  'pill.footer':
    '고른 약은 e약은요, 그다음 DUR(같은 계열 겹침, 같이 먹으면 안 되는 조합, 65세 이상 주의) 순서로 확인해요. 결과는 등록돼 있어요, 의사에게 확인하세요까지만 말해요.',
  'pill.empty':
    '이 조합으로는 못 찾았어요. 약 봉투나 처방전 사진을 찍어 두면 의사에게 보여 줄 수 있어요.',
  ...
  'drawer.title': '진료 기록',
  'drawer.caption': '프로필을 눌러서 개인 진료 남기기',
  'drawer.new': '+ 새 진료 준비',
